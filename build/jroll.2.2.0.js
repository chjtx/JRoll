/*! JRoll v2.2.0 ~ (c) 2015-2016 Author:BarZu Git:https://git.oschina.net/chenjianlong/JRoll2/ Website:http://www.chjtx.com/JRoll/ */
(function(window, document, Math) {
  ...
  utils = {
    ...
    findScroller: function(el, force) {
      ...
      while (el !== document && (force || !(el.tagName === "TEXTAREA" && el.scrollHeight > el.offsetHeight))) {
    ...
    _end: function() {
      ...
      if (s1 || s2 || s3) {
        ...
        if ((s1 && ex1) || (s2 && ex2) || (s3 && (ex1 || ex2))) { //超出边界回弹
          ...
          me.speed = me.speed > 2 ? 2 : me.speed < 0.2 ? 0.2 : me.speed;
          me.moving = true;
