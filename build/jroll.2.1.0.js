...
(function(window, document, Math) {
  ...
  function findScroller(el, force) {
    var id;
  ...
  function _focusin(e) {
    var jroll = findScroller(e.target, true);
    if (jroll)
      jroll._focusin(e);
  }
  ...
  JRoll.prototype = {
    ...
    _focusin: function(e) {
      ...
      setTimeout(function() {
        ...
        if (m > me.options.adjustTop) {
          me.scrollTo(me.x, me.y - m + me.options.adjustTop, 200);
        }
      }, 400);
    },
    ...
    _end: function() {
      ...
      if (s1 || s2 || s3) {
        ...
        } else if (me.options.momentum && me.duration < 200) { //惯性滑动
