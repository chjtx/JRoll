/*! JRoll v2.0.1 ~ (c) 2015-2016 Author:BarZu Git:https://git.oschina.net/chenjianlong/JRoll2/ Website:http://www.chjtx.com/JRoll/ */
(function(window, document, Math) {
  ...
  JRoll.prototype = {
    ...
    _step: function(time) {
      ...
      //防止t为0滑动终止造成卡顿现象
      if (t > 10) {
        me.speed = me.speed - t * me.options.g;
