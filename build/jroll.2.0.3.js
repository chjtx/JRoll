...
(function(window, document, Math) {
  ...
  function findScroller(el) {
    ...
    while (el !== document && !(el.tagName === "TEXTAREA" && el.scrollHeight > el.offsetHeight)) {
  ...
  JRoll.prototype = {
    ...
    _stepBounce: function() {
      ...
      function over() {
        me.scrollTo(me.x, me.y, 150);
      }

      if (me.s === "scrollY") { //y方向

        if (me.directionY === 1) {
          me.scrollTo(me.x, me.minScrollY + 30, 150, true, over);
          me.y = me.minScrollY;
        } else {
          me.scrollTo(me.x, me.maxScrollY - 30, 150, true, over);
          me.y = me.maxScrollY;
        }
        ...
        if (me.directionX === 1) {
          me.scrollTo(me.minScrollX + 30, me.y, 150, true, over);
          me.x = me.minScrollX;
        } else {
          me.scrollTo(me.maxScrollX - 30, me.y, 150, true, over);
          me.x = me.maxScrollX;
        }
    ...
    _move: function(e) {
      ...
      if (now - me.startTime > 200 || me.directionX !== directionX || me.directionY !== directionY) {
        me.startTime = now;
        me.startPositionX = x;
        me.startPositionY = y;
    ...
    _end: function() {
      ...
      if (s1 || s2 || s3) {
        ...
        } else if (me.options.momentum && me.duration > 10 && me.duration < 200) { //惯性滑动
