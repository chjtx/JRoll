/*! JRoll v2.6.4 ~ (c) 2015-2018 Author:BarZu Git:https://github.com/chjtx/JRoll Website:http://www.chjtx.com/JRoll/ */
...
(function (window, document, Math) {
  ...
  JRoll.prototype = {
    ...
    refresh: function (notRefreshEvent) {
      ...
      paddingX = (parseInt(wrapperStyle.paddingLeft) + parseInt(wrapperStyle.paddingRight)) || 0
      paddingY = (parseInt(wrapperStyle.paddingTop) + parseInt(wrapperStyle.paddingBottom)) || 0
      marginX = (parseInt(scrollerStyle.marginLeft) + parseInt(scrollerStyle.marginRight)) || 0
      marginY = (parseInt(scrollerStyle.marginTop) + parseInt(scrollerStyle.marginBottom)) || 0
