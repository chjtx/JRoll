/*! JRoll-FixedInput v1.2.1 ~ (c) 2016 Author:BarZu Git:https://github.com/chjtx/JRoll/tree/master/extends/jroll-fixedinput */
/* global define, JRoll */
(function (window, document, JRoll) {
    ...
    setTimeout(function () {
      if (document.activeElement.tagName !== 'INPUT' && document.activeElement.tagName !== 'TEXTAREA') {
        me.scrollTo(me.x, me.y, 200, false, function () {
          // 判断绘制的方形顶点是否为正则值，如果不是，表明已被手机自动移动过，需要使用scrollIntoView拉正
          if (Math.abs(me.y - me.scroller.getClientRects()[0].top) !== utils.computePosition(me.scroller, document.body).top) {
  ...
  JRoll.prototype.fixedinput.version = '1.2.1'
